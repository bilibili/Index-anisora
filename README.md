...
## 📣 Updates
- `2025/10/31` 🔥 we have released the anisora-anymask model weights, supporting image-to-video generation with temporal and spatial masks. [Huggingface]([https://huggingface.co/IndexTeam/Index-anisora/tree/main/V3.2](https://huggingface.co/IndexTeam/Index-anisora/tree/main/anymask) 
